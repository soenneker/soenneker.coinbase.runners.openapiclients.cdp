...
namespace Soenneker.Coinbase.Runners.OpenApiClients.Cdp.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public FileOperationsUtil(ILogger<FileOperationsUtil> logger, IGitUtil gitUtil, IDotnetUtil dotnetUtil, IProcessUtil processUtil, IYamlUtil yamlUtil, IFileDownloadUtil fileDownloadUtil, IFileUtil fileUtil, IDirectoryUtil directoryUtil, IKiotaUtil kiotaUtil, IOpenApiFixer openApiFixer)
    {
        _logger = logger;
        _gitUtil = gitUtil;
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string jsonFilePath = Path.Combine(gitDirectory, "spec3.json");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "CoinbaseCdpOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
